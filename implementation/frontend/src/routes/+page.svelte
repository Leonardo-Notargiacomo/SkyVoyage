<div class="p-4">
  ...
  <div class="grid grid-cols-2 gap-4 mb-4 mt-5">
    <div class="flex justify-center">
      <div
        role="status"
        class="max-w-sm p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700 w-full"
      >
        <div
        ...
        <div class="flex items-baseline mt-4">
          <div
            class="w-full bg-gray-200 rounded-t-lg h-72 dark:bg-gray-700"
          ></div>
          <div
