    ...
    <ol class="inline-flex items-center space-x-2">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-400">Customers</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="max-w-6xl mx-auto p-6">
    <div class="flex justify-between items-center mb-8">
        ...
        <div>
            <button onclick={() => isOpen = !isOpen } class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-5 rounded-lg shadow-sm transition-all duration-200 transform hover:-translate-y-0.5" type="button">
                Add customer
            </button>
        </div>
    </div>
            ...
            <form class="p-4 md:p-5" onsubmit={ createCustomer }>
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="lastName" id="lastName" placeholder="Last name" required="" bind:value={ newCustomer.lastName } class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    </div>
