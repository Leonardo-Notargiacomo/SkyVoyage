...
This document contains the user stories for the Flight Ticket Sales application project. Each story follows the format of describing the **role**, **action**, and **goal**.
