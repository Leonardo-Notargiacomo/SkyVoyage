# Flight Ticket Sales Application

## User Stories
This document outlines the user stories for the Flight Ticket Sales application project. Each story follows the format of describing the **role**, **action**, and **goal**.
...
- As a Sales Employee, I want to view available flights so that I can provide customers with suitable flight options.
...
- As a Sales Employee, I want to enter details of the customer making the booking (name, email, phone, address) so that I have all necessary information.
- As a Sales Employee, I want to finalize bookings after payment is confirmed so that the booking process is complete.
- As a Sales Employee, I want to cancel bookings so that I can manage customer requests.
...
- As a Sales Manager, I want to log in to the system so that I can access the application.
